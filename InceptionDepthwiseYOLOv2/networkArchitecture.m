function lgraph = networkArchitecture
...
% 
% Auto-generated by MATLAB on 14-Apr-2022 20:51:51
%% Create Layer Graph
...
tempLayers = additionLayer(2,"Name","res11");
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = [
    convolution2dLayer([1 1],52,"Name","conv_4_1_1_1","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_1_1_1","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_1_1_1")
    groupedConvolution2dLayer([5 5],1,"channel-wise","Name","groupedconv_2_1_1","Padding","same")
    batchNormalizationLayer("Name","batchnorm_4_1_1","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_9_1_1_1")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],102,"Name","conv_4_2_1_1","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_2_1_1","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_2_1_1")
    groupedConvolution2dLayer([3 3],1,"channel-wise","Name","groupedconv_3_1_1","Padding","same")
    batchNormalizationLayer("Name","batchnorm_7_1_1","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_5_1_1")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],102,"Name","conv_4_3_2_1","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_3_2_1","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_3_2_1")
    groupedConvolution2dLayer([1 1],1,"channel-wise","Name","groupedconv_3_2_1","Padding","same")
    batchNormalizationLayer("Name","batchnorm_7_2_1","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_5_2_1")];
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = [
    depthConcatenationLayer(3,"Name","depthcat_2_1")
...
tempLayers = additionLayer(2,"Name","res19");
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = [
    convolution2dLayer([1 1],205,"Name","conv_4_3_2_2","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_3_2_2","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_3_2_2")
    groupedConvolution2dLayer([1 1],1,"channel-wise","Name","groupedconv_3_2_2","Padding","same")
    batchNormalizationLayer("Name","batchnorm_7_2_2","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_5_2_2")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],102,"Name","conv_4_1_1_2","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_1_1_2","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_1_1_2")
    groupedConvolution2dLayer([5 5],1,"channel-wise","Name","groupedconv_2_1_2","Padding","same")
    batchNormalizationLayer("Name","batchnorm_4_1_2","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_9_1_1_2")];
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = [
    convolution2dLayer([1 1],205,"Name","conv_4_2_1_2","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_2_1_2","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_2_1_2")
    groupedConvolution2dLayer([3 3],1,"channel-wise","Name","groupedconv_3_1_2","Padding","same")
    batchNormalizationLayer("Name","batchnorm_7_1_2","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_5_1_2")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = depthConcatenationLayer(3,"Name","depthcat_2_2");
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = additionLayer(2,"Name","res23");
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],204,"Name","conv_4_1_1_3","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_1_1_3","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_1_1_3")
    groupedConvolution2dLayer([5 5],1,"channel-wise","Name","groupedconv_2_1_3","Padding","same")
    batchNormalizationLayer("Name","batchnorm_4_1_3","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_9_1_1_3")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],410,"Name","conv_4_3_2_3","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_3_2_3","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_3_2_3")
    groupedConvolution2dLayer([1 1],1,"channel-wise","Name","groupedconv_3_2_3","Padding","same")
    batchNormalizationLayer("Name","batchnorm_7_2_3","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_5_2_3")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],410,"Name","conv_4_2_1_3","Padding","same")
    batchNormalizationLayer("Name","batchnorm_6_2_1_3","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_4_2_1_3")
    groupedConvolution2dLayer([3 3],1,"channel-wise","Name","groupedconv_3_1_3","Padding","same")
    batchNormalizationLayer("Name","batchnorm_7_1_3","Epsilon",0.001)
    leakyReluLayer(0.01,"Name","leakyrelu_5_1_3")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    depthConcatenationLayer(3,"Name","depthcat_2_3")
    resize2dLayer("Name","resize-scale","GeometricTransformMode","half-pixel","Method","bilinear","NearestRoundingMode","round","Scale",[2 2])];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    depthConcatenationLayer(3,"Name","depthcat")
    dropoutLayer(0.5,"Name","dropout")
    convolution2dLayer([3 3],1024,"Name","yolov2Conv1","Padding","same","WeightsInitializer",@(sz)randn(sz)*0.01)
    batchNormalizationLayer("Name","yolov2Batch1")
    reluLayer("Name","yolov2Relu1")
    convolution2dLayer([3 3],1024,"Name","yolov2Conv2","Padding","same","WeightsInitializer",@(sz)randn(sz)*0.01)
    batchNormalizationLayer("Name","yolov2Batch2")
    reluLayer("Name","yolov2Relu2")
    convolution2dLayer([1 1],36,"Name","yolov2ClassConv","WeightsInitializer",@(sz)randn(sz)*0.01)
    yolov2TransformLayer(6,"Name","yolov2Transform")
    yolov2OutputLayer([32 9;103 34;193 66;62 18;140 41;42 13],"Name","yolov2OutputLayer")];
lgraph = addLayers(lgraph,tempLayers);
...
lgraph = connectLayers(lgraph,"res11","conv27");
lgraph = connectLayers(lgraph,"res11","conv_4_1_1_1");
lgraph = connectLayers(lgraph,"res11","conv_4_2_1_1");
lgraph = connectLayers(lgraph,"res11","conv_4_3_2_1");
lgraph = connectLayers(lgraph,"leakyrelu_9_1_1_1","depthcat_2_1/in3");
lgraph = connectLayers(lgraph,"leakyrelu27","conv28");
lgraph = connectLayers(lgraph,"leakyrelu27","res12/in2");
lgraph = connectLayers(lgraph,"leakyrelu_5_1_1","depthcat_2_1/in2");
...
lgraph = connectLayers(lgraph,"leakyrelu_5_2_1","depthcat_2_1/in1");
...
lgraph = connectLayers(lgraph,"res19","conv44");
lgraph = connectLayers(lgraph,"res19","conv_4_3_2_2");
lgraph = connectLayers(lgraph,"res19","conv_4_1_1_2");
lgraph = connectLayers(lgraph,"res19","conv_4_2_1_2");
lgraph = connectLayers(lgraph,"leakyrelu_5_2_2","depthcat_2_2/in1");
lgraph = connectLayers(lgraph,"leakyrelu_9_1_1_2","depthcat_2_2/in3");
...
lgraph = connectLayers(lgraph,"leakyrelu_5_1_2","depthcat_2_2/in2");
lgraph = connectLayers(lgraph,"depthcat_2_2","depthcat/in1");
...
lgraph = connectLayers(lgraph,"res23","conv_4_1_1_3");
lgraph = connectLayers(lgraph,"res23","conv_4_3_2_3");
lgraph = connectLayers(lgraph,"res23","conv_4_2_1_3");
lgraph = connectLayers(lgraph,"leakyrelu_5_2_3","depthcat_2_3/in1");
lgraph = connectLayers(lgraph,"leakyrelu_9_1_1_3","depthcat_2_3/in3");
lgraph = connectLayers(lgraph,"leakyrelu_5_1_3","depthcat_2_3/in2");
lgraph = connectLayers(lgraph,"resize-scale","depthcat/in3");
%% Plot Layers
