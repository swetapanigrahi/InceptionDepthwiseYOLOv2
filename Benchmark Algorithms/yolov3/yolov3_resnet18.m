...
lgraph = resnet18FeatureExtractor(baseNetwork, networkInputSize);
%% 
...
lgraph = connectLayers(lgraph, 'res5b', 'conv1Detection1');
lgraph = connectLayers(lgraph, 'relu1Detection1', 'upsample1Detection2');
lgraph = connectLayers(lgraph, 'res4b', 'depthConcat1Detection2/in2');
