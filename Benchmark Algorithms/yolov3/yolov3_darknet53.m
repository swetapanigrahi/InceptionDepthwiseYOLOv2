...
baseNetwork = darknet53;
lgraph = darknetFeatureExtractor(baseNetwork, networkInputSize);
%% 
...
lgraph = connectLayers(lgraph, 'res23', 'conv1Detection1');
lgraph = connectLayers(lgraph, 'relu1Detection1', 'upsample1Detection2');
lgraph = connectLayers(lgraph, 'res19', 'depthConcat1Detection2/in2');
