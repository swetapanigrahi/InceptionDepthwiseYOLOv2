function d = data_table_test(r)


% r=224.0
fid = fopen('/home/cse/Documents/Sweta/INRIAPerson/Test/annotations.lst','r');
...
pid = fopen('/home/cse/Documents/Sweta/INRIAPerson/Test/pos.lst','r');

pn = textscan(pid,'%s',1,'delimiter','\n', 'headerlines',i-1);
pname = pn{1,1}{1,1};
f_name = textscan(pname(10:end),'%s','delimiter','/');
ppath = fullfile('/home/cse/Documents/Sweta/INRIAPerson/Test/pos/',f_name{1,1});

img = imread(fullfile('/home/cse/Documents/Sweta/INRIAPerson/Test/pos/',f_name{1,1}{1,1}));
% [ih,iw]=size(img);
ih = size(img,1);
iw = size(img,2);
